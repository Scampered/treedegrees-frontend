...
function SectionJobs() {
  const jobs = [
    ...
    { icon: "🌱", name: "Seed Broker", what: "Invest a client's seeds across multiple targets — connections, Canopy, or Crude. Allocate specific amounts to each. Earn 10% of profits on close.", client: "Allocate seeds to a broker for a set time (1h to 1 week). They invest on your behalf with 100% active exposure.", earn: "10% of profits + 5% management fee" },
    { icon: "📊", name: "Accountant", what: "View a client's portfolio anonymously (Investment #1, #2 etc) and send Buy/Hold/Sell advice with a note. One report per 24h.", client: "Grant an accountant read access. They analyse your positions and send advice. You see their name and the full investment name.", earn: "Per report fee (set by you)" },
    { icon: "🔔", name: "Steward", what: "Monitor up to 3 clients' active streaks. Send nudges when fuel drops to 1. You see streak counts but not who they're with.", client: "Pay a retainer (3, 7, or 14 days, prorated). Your steward watches your streaks and nudges you before they break.", earn: "Retainer fee per contract period" },
    ...
    { icon: "🌾", name: "Farmer", what: "Grow seeds in plot slots. Plant your own seeds or client deposits. After 24h, harvest with outcomes from rotten (x0) to bumper (x2.5). No fees.", client: "Deposit seeds into a farmer's plot. The farmer plants them and after 24h the harvest returns to you.", earn: "Profit from your own planted seeds" },
  ]
